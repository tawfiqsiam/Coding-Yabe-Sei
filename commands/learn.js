...
exports.help = {
    ...
    usage: "For starters, the command to initiate the learning mode for Yabe is `ya123be learn`. You then add more arguments to that to learn more about specified things.\n" +
            "**Examples:**\n" +
            "The command to learn about an if statement in JavaScript would be `123 learn js if`, or to learn about print statements in ruby, you would do `yabe learn rb print`.\n\nTo see what Yabe offers for each language, use `yabe learn <name of language>`\n\nUse `yabe learn langs` to view a list of languages.",
}
